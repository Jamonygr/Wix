"""
Publish New Blogs to Wix
Publishes the 6 new Azure Copilot Agent blog posts
"""
...
# New blog files to publish (39-44) - Azure Copilot Agents
NEW_BLOG_FILES = [
    'blog_39_copilot_agents_preview.py',
    'blog_40_deployment_agent.py',
    'blog_41_observability_agent.py',
    'blog_42_optimization_agent.py',
    'blog_43_resiliency_agent.py',
    'blog_44_troubleshooting_agent.py',
]
...
def main():
    """Main function to publish new blogs"""
    print("=" * 60)
    print("Publishing 13 New Azure Blogs (26-38)")
    print("=" * 60)
    ...
    print(f"\nSite ID: {SITE_ID}")
    print(f"Number of blogs to publish: {len(NEW_BLOG_FILES)}")
    ...
    for i, blog_file in enumerate(NEW_BLOG_FILES, 1):
        print(f"\n[{i}/{len(NEW_BLOG_FILES)}] Processing {blog_file}...")
